...
:computer: **Currently:** Working on a MERN stack application with user authentication & playing around with GSAP<br/>
:seedling: **Learning:** DevOps and automated deployment, Cloud services (AWS, Azure, IBM Cloud...), Agile mindset and practices, Unit testing, Docker, GSAP<br/>
